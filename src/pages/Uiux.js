...
const Uiux = ({ setNeedToHideNavFoot }) => {
  ...
  }, [showProject, indexProject, currentNumber]);
  ...
  return (
    <UiuxContainer>
      <div className='left space'>
        ...
        >
          <div className='name'>{showProject.appName}</div>
          <div className='desc'>{showProject.short}</div>
      ...
      <div
        ...
        style={{ backgroundColor: `${showProject.theme}` }}
      >
        <motion.img
          initial={{ y: "100%" }}
          animate={{ y: "0%" }}
